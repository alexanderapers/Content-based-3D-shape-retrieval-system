...
if __name__ == "__main__":
    dataset_original = Dataset("Princeton", write_basic_csv = False, write_other_csv = True)
    resample(dataset_original)

    dataset = Dataset("Princeton_normalized", write_basic_csv = False, write_other_csv = True)
